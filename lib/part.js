...
Part.prototype = {
  ...
  contentLocationPrefix: function() {
    ...
    if (!location) {
      ...
      if (locationUrl.pathname.length > 0) {
        return locationUrl.href.substring(0, locationUrl.href.indexOf(locationUrl.pathname));
      } else {
        return location;
      }
    }
  ...
  hasContentLocationPrefix: function(prefix) {
    if (!this.meta('content-location') || !prefix) {
      ...
      return this.meta('content-location').toLowerCase().indexOf(prefix) === 0
    }
  },
